...
public class GameManager : NetworkBehaviour
{
    ...
    private static GameState currentState = GameState.Pregame;
    private float _brickWidth = 1;
    private float _brickHeight = 1;
    private static int _score = 0;
    private static GameManager instance = null;
    public static void SetGameState(GameState value) { currentState = value; }
    ...
    private void Update()
    {
        SetScoreText("Score = " + GetScore().ToString());
    }
